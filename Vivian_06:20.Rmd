...
All patient encounters associated with a discharge to hospice or death will be removed. 
```{r}
...
# Feature Creation of Primary Diagnosis (all levels w/ less than 2500 instances are combined into 'Other')
library(dplyr)
...
barplot(ct_A1C1,main="A1C Result",xlab="A1C Result",ylab="Readmitted",col=c("blue", "orange"),legend=rownames(ct_A1C))
