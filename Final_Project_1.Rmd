...
* Notes: knnimputation doesn't work b/c categorical variables have not been converted to dummies. Commented out code to center/scale training data as this is already done w/ knn imputation.  
...
library(caret)
#train_impute <- preProcess(trainX, "knnImpute")
...
```{r}
#Note: knnimputation automatically centers and scales the data, so this code would be unnecessary. Commenting it out for now
