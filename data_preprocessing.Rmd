...
#id mapping of admission type
head(ids_map)
head(table(ids_map$description))
```
```{r}
...
## Need to fix diag_1, diag_2, diag_3 back into characters
```

**Explore various predictors**
```{r}
#blood sugar (A1Cresult)
table(data$A1Cresult)

#if patient was prescribed diabetic medication
